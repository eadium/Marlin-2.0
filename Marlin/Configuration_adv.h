...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 100*60, 100*60, 3*60, 50*60 } // Feedrates for manual moves along X, Y, Z, E from panel
...
#define LCD_TIMEOUT_TO_STATUS 130000
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       517        // (mA) RMS current. Multiply by 1.414 for peak current.
